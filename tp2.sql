...
/****** Object:  Database [TP2]    Script Date: 26/06/2022 12:35:49 ******/
CREATE DATABASE [TP2]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'TP2', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\TP2.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'TP2_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\TP2_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [TP2] SET  ENABLE_BROKER 
GO
...
ALTER DATABASE [TP2] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
